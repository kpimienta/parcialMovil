...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table SUBJECTS (ID_SUBJECT TEXT PRIMARY KEY, SUJECT_NAME TEXT)");
        db.execSQL("create table GRADES (ID_GRADE INTEGER PRIMARY KEY AUTOINCREMENT,FK_ID_SUBJECT TEXT, N1 NUMBER,N2 NUMBER,N3 NUMBER,FOREIGN KEY(FK_ID_SUBJECT) REFERENCES SUBJECT(ID_SUBJECT))");
 }
